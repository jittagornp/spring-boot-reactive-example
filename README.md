...
เพราะ Repository สร้างขึ้นมาด้วยความตั้งใจว่า อยากที่จะทำอะไรดี ๆ ให้สังคมจริง ๆ 
...
Spring-boot เป็น Subset ของ Spring Framework เป็นการเอา Ecosystem ต่าง ๆ ของ Spring ที่มีอยู่ มาประกอบร่างรวมกัน เพื่อให้ใช้งาน Spring ได้ง่ายขึ้น โดยมีจุดเด่นดังนี้
